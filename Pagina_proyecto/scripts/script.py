function actualizarOpciones() {
            ...
            if (tipoMonitoria === 'academica') {
                var academicaOptions = [
                    ...
                    { value: 'programacion_modular', text: 'Estructura de Datos' }
                ...
                var administrativaOptions = [
                    ...
                    { value: 'area_administracion', text: 'Área de Admisiones' },
                    { value: 'area_administracion', text: 'Área de Recursos Humanos' }
                    // Agrega más opciones según sea necesario
                ];
